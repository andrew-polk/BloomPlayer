...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var navigation_1 = __webpack_require__(1);
	var layout_1 = __webpack_require__(7);
	var animation_1 = __webpack_require__(10);
	var music_1 = __webpack_require__(11);
	var narration_1 = __webpack_require__(12);
	function attach() {
	    navigation_1.SetupNavigation();
	    layout_1.SetupLayout();
	    animation_1.SetupAnimation();
	    music_1.SetupMusic();
	    narration_1.SetupNarration();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SetupNavigation() {
	    exports.PageVisible = new event_1["default"]();
	    exports.PageHidden = new event_1["default"]();
	...
	function handleClick(event) {
	    ...
	    if (current) {
	        ...
	        exports.PageHidden.raise(current);
	        //find the next one
	        var next = current.nextElementSibling;
	        if (next) {
	            next.classList.add("currentPage");
	            exports.PageVisible.raise(next);
	        }
	        else {
	            // wrap around (review)
	            showFirstPage();
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./navigation.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./navigation.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#playerToolbar {\n  position: fixed;\n  top: 0;\n  /*height: 50px;*/\n  background-color: #363333;\n  width: 100%;\n  color: white;\n  padding: 10px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SetupLayout() {
	    adjust();
	    window.addEventListener('resize', function () { return adjust(); }, false);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SetupAnimation() {
	    navigation_1.PageVisible.subscribe(function (page) {
	    });
	    navigation_1.PageHidden.subscribe(function (page) {
	    });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SetupNarration = SetupNarration;


/***/ }
/******/ ]);
//# sourceMappingURL=bloomPlayer.js.map